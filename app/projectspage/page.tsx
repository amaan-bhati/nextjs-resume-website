...
{/* UI Projects here */}
      ...
      {/* 
        Reminder: When adding a new section to the projects page:
        1. Add the new section here in the page.tsx file
        2. Create a new component file (e.g., new-section-card.tsx) if needed
        3. Add the corresponding data in the resume.tsx file
      */}
      ...
      <section id="projects">
        <div className="space-y-12 w-full py-12">
          ...
          <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 max-w-[800px] mx-auto">
            {DATA.pythonProjects.map((project, id) => (
              <BlurFade
                key={project.title}
                delay={BLUR_FADE_DELAY * 12 + id * 0.05}
              >
